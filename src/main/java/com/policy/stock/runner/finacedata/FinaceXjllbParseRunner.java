...
public class FinaceXjllbParseRunner extends Thread {

	private String baseUrl = "http://quotes.money.163.com/f10/xjllb_{stockCode}.html?type=year";

	private String stockCode;
	
	private IFinaceDataService finaceDataService;

	public FinaceXjllbParseRunner(IFinaceDataService service) {
